...
# Remembers a user in the database for use in persistent sessions.
  ...
  def authenticated?(remember_token)
     return false if remember_digest.nil?
  	#Note: remember_digest attribute,is same as self.remember_digest, 
  	#      it is created automatically by Active Record based on the name of corresponding database column.
